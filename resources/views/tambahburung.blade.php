        ...
        <div class="container">
            ...
            <div class="container p-5" style="width: 50%; border: 1px solid black">
                ...
                <form action="/add-burung/{{ $id }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-outline-primary" style="width: 80px">Batal</button>
